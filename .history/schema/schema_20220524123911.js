...
const innitiateConstraints = () => {
    try{
        ...
        SpawnParts.belongsTo(Spawns, {foreignKey:"partsId"})
        // parents
            ...
            spawnSkills:{type:new GraphQLList(SkillsType),
                async resolve (parent) {
                    try{
                        ...
                        console.log(skillObj, "Skill OBJ lies HERE")
            ...
            spawnAddress:{type: SpawnAddressType,
                async resolve (parent) {
                    try{
                        ...
                        console.log(fetchSpawnAddress.dataValues, "HERE LOOK AT THIS")                    
    ...
    fields:{
        ...
        async resolve(parent, args){
            ...
            try {
                ...
                const newSpawnAddress = await SpawnAddress.create({
                    spawnId,
                    metadata:"metadata",
                    imageAtlas:args.imageAddress,
                    atlas:"atlas"
                })


                const newParent = await SpawnsParents.create({
                    spawnId: spawnId,
                    parentX: "e7d8497e-c0fa-4ec1-97c8-53221236a3f8",
                    parentY: "eaab84fb-2f2a-40e5-9ed3-f5b8e61357aa", 
                ...
                const newParts = await SpawnParts.create({
                    id: spawnId,
                    name: "Leg", 
                    imageAddress: "hand", 
                    class: "ave",
                ...
                const newSkill = await SpawnSkills.create({
                    spawnId:"eaab84fb-2f2a-40e5-9ed3-f5b8e61357aa",
                    skill1:"eaab84fb-2f2a-40e5-9ed3-f5b8e61357aa",
                    skill2:"eaab84fb-2f2a-40e5-9ed3-f5b8e61357aa",
                    skill3:"eaab84fb-2f2a-40e5-9ed3-f5b8e61357aa",
                })
